...
### Target Users  
- Undergradute students specializing in DSA.
...
3. Backend updates mastery probability using model.  
4. Gap detection logic checks prerequisite performance.  
5. Database stores updated mastery state.  
6. Backend returns:  
...
4. System calculates mastery probability  
5. If mastery ≥ threshold: Unlock next checkpoint  
6. If mastery < threshold: Trigger prerequisite quiz  
7. Based on prerequisite results:  
...
### Short-Term  
- Add more subjects and expand checkpoint structures  
- Improve question bank depth and diagnostic precision  
- Enhance institutional analytics dashboard  

### Long-Term  
- Introduce personalized mentor feature  
- Integrate AI-driven conversational doubt resolution  
...
- Effectiveness depends on quality and size of question bank  
- Bayesian model may not capture highly complex learning behaviors  
...
- Simplifies learning by providing curated resources  
